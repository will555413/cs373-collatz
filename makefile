FILES :=                              \
    .travis.yml                       \
    collatz-tests/wc6892-RunCollatz.in   \
    collatz-tests/wc6892-RunCollatz.out  \
    collatz-tests/wc6892-TestCollatz.out \
    collatz-tests/wc6892-TestCollatz.py  \
    Collatz.html                      \
    Collatz.log                       \
    Collatz.py                        \
    RunCollatz.in                     \
...
TestCollatz.tmp: TestCollatz.py
	python3-coverage run    --branch TestCollatz.py >  TestCollatz.out 2>&1
	python3-coverage report -m                      >> TestCollatz.out
	cat TestCollatz.out
